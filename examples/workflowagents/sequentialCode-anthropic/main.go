...
// Package demonstrates a coding workflow agent that runs Anthropic-powered sub-agents sequentially.
//
// This implements a code generation pipeline:
// 1. CodeWriterAgent - Generates initial code from specification
// 2. CodeReviewerAgent - Reviews the code and provides feedback
// 3. CodeRefactorerAgent - Refactors the code based on review
//
// Run with:
//
//	godotenv go run ./examples/workflowagents/sequentialCode-anthropic
//
...
Do not add any other text before or after the code block.`,
	...
	if err != nil {
		log.Fatalf("Failed to create codeWriterAgent: %v", err)
	}
...
Output *only* the review comments or the "No major issues" statement.`,
	...
	if err != nil {
		log.Fatalf("Failed to create codeReviewerAgent: %v", err)
	}
...
Do not add any other text before or after the code block.`,
	...
	if err != nil {
		log.Fatalf("Failed to create codeRefactorerAgent: %v", err)
	}
	...
	codePipelineAgent, err := sequentialagent.New(sequentialagent.Config{
		AgentConfig: agent.Config{
			...
			Description: "Executes a sequence of code writing, reviewing, and refactoring using Anthropic Claude.",
		},
	})
	if err != nil {
		log.Fatalf("Failed to create codePipelineAgent: %v", err)
	}
